...
const paymentSchema = new mongoose.Schema({
  ...
  platformFee:    { type: Number, default: 0, description: 'Platform fee in LKR' },
  serviceFee:     { type: Number, default: 0, description: 'Service/processing fee in LKR' },
  taxAmount:      { type: Number, default: 0, description: 'Tax amount in LKR' },

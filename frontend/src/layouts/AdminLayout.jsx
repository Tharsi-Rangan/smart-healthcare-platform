...
function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-cyan-50/30 to-sky-50/30 text-slate-800">
      {/* Fixed Sidebar */}
      <aside className="fixed left-0 top-0 h-screen w-72 flex flex-col bg-white border-r border-slate-200 overflow-y-auto z-50 shadow-lg shadow-slate-200/50">
        ...
        <div className="px-5 pt-6 pb-5">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-linear-to-br from-cyan-600 to-sky-700 text-white shadow-lg shadow-cyan-500/25">
        ...
        {/* User Profile Card */}
        <div className="mx-3 mb-3 p-3 rounded-xl bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-100 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-br from-cyan-600 to-sky-700 text-sm font-semibold text-white shadow-md shadow-cyan-500/25">
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 rounded-xl bg-slate-50 px-2.5 py-1.5 border border-slate-100">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-linear-to-br from-cyan-600 to-sky-700 text-xs font-semibold text-white shadow-md shadow-cyan-500/25">
                  {user?.name?.[0]?.toUpperCase() || "A"}
                </div>

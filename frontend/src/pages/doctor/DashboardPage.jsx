...
function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Hero */}
      <section className="overflow-hidden rounded-[32px] border border-slate-200 bg-gradient-to-r from-cyan-600 via-sky-700 to-slate-900 text-white shadow-sm">
      ...
      <section className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2 xl:grid-cols-5">
          <Link
            to="/doctor/profile"
            className="rounded-[24px] border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-1 hover:bg-white hover:shadow-md"
          >
      ...
      <section className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {availability.length > 0 ? (
            ...
            <div className="md:col-span-2 xl:col-span-3 rounded-[24px] border border-dashed border-slate-300 bg-slate-50 p-8 text-center">
